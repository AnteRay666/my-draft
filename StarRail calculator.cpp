...
int Sum(sample a[],int n)
{
	...
	cout << "总计次数： " << times<< endl;
	cout << "紫色次数： " << sum2 << endl;
	cout << "蓝色次数： " << sum3 << endl;
	cout << "绿色次数： " << sum4 << endl;
	cout << endl;
	cout << "统计紫色概率： " << fixed << setprecision(2) << 100*sum2 / times << "%" << endl;
	cout << "统计蓝色概率： " << fixed << setprecision(2) << 100*sum3 / times << "%" << endl;
	cout << "统计绿色概率： " << fixed << setprecision(2) << 100*sum4 / times << "%" << endl;
	return 0;
}
